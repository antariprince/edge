...
(function(compId) {
    ...
    function simpleContent(a, d, b) {
        ...
        for (var n = 0; n < a.length; n++) {
            b = a[n];
            "image" === b.type ? (k = document.createElement("img"),
                k.src = b.fill[1]) : k = document.createElement("div");
            k.id = b.id;
            h = k.style;
            if ("text" == b.type) {
    ...
    aLoader = [{
        load: "assets/jquery.js"
    }, {
        load: "assets/edge.min.js"
    }, {
        load: "assets/beforeafter_edge.js"
    }, {
        load: "assets/beforeafter_edgeAction.js"
    }];
